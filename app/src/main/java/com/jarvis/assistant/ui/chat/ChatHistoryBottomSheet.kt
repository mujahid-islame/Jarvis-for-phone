...
class ChatHistoryBottomSheet : Fragment() {
    ...
    private fun addMemoryRow(
        ...
        val row = LinearLayout(requireContext()).apply {
            ...
            setPadding(12, 8, 4, 8)
            setBackgroundResource(com.jarvis.assistant.R.drawable.bg_input_field)
        ...
        val textView = TextView(requireContext()).apply {
            text = "$icon  $title\n$content"
            setTextColor(resources.getColor(com.jarvis.assistant.R.color.text_primary, null))
            textSize = 12f
    ...
    private fun createMemoryAction(label: String, action: () -> Unit): TextView {
        return TextView(requireContext()).apply {
            ...
            setTextColor(
                resources.getColor(
                    if (label == "DELETE") com.jarvis.assistant.R.color.status_red
                    else com.jarvis.assistant.R.color.primary_cyan,
                    null
                )
            )
            textSize = 9f
