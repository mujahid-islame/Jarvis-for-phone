...
object AssistantCommandParser {
    ...
    private val PHONE_NAVIGATION_PHRASES = listOf("scroll down", "scroll up", "swipe down", "swipe up", "click video", "click on", "tap on", "type ", "write ", "go back", "go home", "home screen", "recent apps", "open notifications", "open quick settings", "স্ক্রল নিচে", "স্ক্রল উপরে", "নিচে স্ক্রল", "উপরে স্ক্রল", "ভিডিওতে ক্লিক", "লিখে দাও", "পেছনে যাও", "হোমে যাও", "সাম্প্রতিক অ্যাপ", "নোটিফিকেশন খোলো", "কুইক সেটিংস খোলো")
    ...
    private val DEVICE_PHRASES = listOf("wifi settings", "wi-fi settings", "bluetooth settings", "volume up", "volume down", "brightness", "screen brightness", "increase brightness", "decrease brightness", "open settings", "open the settings", "settings open", "setting", "settings", "display settings", "sound settings", "battery settings", "app settings", "notification settings", "ওয়াইফাই সেটিংস", "ব্লুটুথ সেটিংস", "সেটিংস", "সেটিং খোলো", "ডিসপ্লে সেটিংস", "সাউন্ড সেটিংস", "ভলিউম বাড়াও", "ভলিউম কমাও", "ব্রাইটনেস", "উজ্জ্বলতা বাড়াও", "উজ্জ্বলতা কমাও")
