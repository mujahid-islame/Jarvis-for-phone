...
object AssistantCommandParser {
    ...
    private val DEVICE_PHRASES = listOf("wifi settings", "wi-fi settings", "bluetooth settings", "volume up", "volume down", "open settings", "open the settings", "settings open", "setting", "settings", "display settings", "sound settings", "battery settings", "app settings", "notification settings", "ওয়াইফাই সেটিংস", "ব্লুটুথ সেটিংস", "সেটিংস", "সেটিং খোলো", "ডিসপ্লে সেটিংস", "সাউন্ড সেটিংস", "ভলিউম বাড়াও", "ভলিউম কমাও")
